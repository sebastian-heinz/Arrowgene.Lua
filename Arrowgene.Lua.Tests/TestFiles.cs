...
/// <summary>
/// Port of unluac.test.TestFiles — master list of test file names.
/// Mirrors the official unluac SourceForge test suite.
/// </summary>
public static class TestFiles
{
    public static readonly TestFile[] Tests =
    {
        ...
        new TestFile("break22", TestFile.DEFAULT_VERSION, TestFile.RELAXED_SCOPE),
        new TestFile("break23", TestFile.DEFAULT_VERSION, TestFile.RELAXED_SCOPE),
        ...
        new TestFile("close13"),
        new TestFile("always01"),
        new TestFile("always02"),
        new TestFile("always03"),
        new TestFile("always04"),
        new TestFile("once01", TestFile.DEFAULT_VERSION, TestFile.RELAXED_SCOPE),
        new TestFile("once02"),
        new TestFile("once03"),
        new TestFile("once04"),
        new TestFile("once05"),
